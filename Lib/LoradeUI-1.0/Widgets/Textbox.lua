...
LoradeUI.Textbox = {}; 
LoradeUI.Button__index = LoradeUI.Textbox;   
function LoradeUI.Textbox:Create(Name, Parent, XPos, YPos, Width, Height, Text, Template, Visible)
	local self = {};
	setmetatable(self, LoradeUI.Textbox); 
