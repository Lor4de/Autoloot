...
Autoloot = LibStub("AceAddon-3.0"):GetAddon("Autoloot")
local L = LibStub("AceLocale-3.0"):GetLocale("Autoloot")

Autoloot.Console = LoradeConsole.Console:Create("Autoloot", "/autoloot")

-------------------------------------------------------------------------------------------------------

Autoloot.Console:RegisterKeyword("", (function()
	Autoloot.Console:Print("[[Autoloot "..LoradeConsole.Seperator.." Console "..LoradeConsole.Seperator.." Modules]]");
	Autoloot.Console:Print(LoradeConsole.Spacer);
...
-------------------------------------------------------------------------------------------------------
	...
	Autoloot.Console:RegisterKeyword("Show", (function()
		if Autoloot.Interface.MainBackgroundFrame:IsVisible() == true then
			Autoloot.Interface.MainBackgroundFrame:Hide();
		else
			Autoloot.Interface.MainBackgroundFrame:Show();
		end
	end))
