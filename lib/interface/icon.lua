...
Interface.Icon = {}; 
Interface.Icon__index = Interface.Icon;   
function Interface.Icon:Create(Name, Parent, XPos, YPos, Size, Texture, Template, Visible)
	local self = {};
	setmetatable(self, Interface.Icon); 
...
------------------------------------------------------------------------------------------------------- 
 ...
 Interface.Icon:Create("Test", UIParent, 0, 0, 32, "SecureActionButtonTemplate", true)
