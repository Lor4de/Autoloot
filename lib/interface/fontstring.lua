...
Interface.Fontstring__index = Interface.Fontstring;   
function Interface.Fontstring:Create(Name, Parent, XPos, YPos, Text, Font, Visible)
	local self = {};
	setmetatable(self, Interface.Fontstring); 
...
------------------------------------------------------------------------------------------------------- 
	...
	function self:SetMultiline(Multiline)
		self.Framepointer:SetWordWrap(enable)
	end
